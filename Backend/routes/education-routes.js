...
router.post("/create", async (req, res) => {
    try {
        ...
        const newData = new education(payload);
...
router.put("/update/:dataID", (req,res)=>{
    try{
        education.findByIdAndUpdate({ _id: req.params.dataID }, { $set: req.body }, (err,data)=>{
            if(err){
...
router.delete("/delete/:dataID", (req,res)=>{
    try{
        education.deleteOne({ _id: req.params.dataID }, (err,data)=>{
            if(err){
